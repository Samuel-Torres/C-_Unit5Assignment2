...
int main()
{
	...
	cout << "PI, RATE, findArea, findCircumference, and radius are active here" << endl
		 << endl;

	{
		...
		cout << "PI, RATE, findArea, findCircumference, radius (outer), and area are active here" << endl
			 << endl;
...

	{
		...
		cout << "PI, RATE, findArea, findCircumference, radius (inner), and circumference are active here" << endl
			 << endl;
...
void findArea(float rad, float &answer)
{
	cout << "AREA FUNCTION" << endl
		 << endl;
	cout << "PI, RATE, rad, and answer are active here" << endl
		 << endl;
...
void findCircumference(float length, float &distance)
{
	cout << "CIRCUMFERENCE FUNCTION" << endl
		 << endl;
	cout << "PI, RATE, length, and distance are active here" << endl
		 << endl;
