...
int main()
{
	...
	// Call convertMulti with parameters dollars, euros, and pesos
	convertMulti(dollars, euros, pesos);

	// Output the value of those dollars converted to both euros and pesos
	...
	// Call convertMulti with parameters dollars, euros, pesos and yen
